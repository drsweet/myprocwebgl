...
function showshield() {
	...
	document.getElementById('cl_loadinglabel').style.visibility = 'hidden';
			...
			function startMapLoading(path,distance,anatCont,alt) {
				...
				if (c_w>distance) {
					document.getElementById('imgX').width = c_w - distance;
                    document.getElementById('imgX').style.width = c_w;
				}
				document.getElementById('imgZ').width = c_w;
                document.getElementById('imgZ').style.width = c_w;
				...
				//variables needed to activate camera panning
				draggingNode = null; distance = 0; folder = null; folderTransformation = null; folderTransformationInv = null; itemWasDragged = false;
