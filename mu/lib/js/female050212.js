leftpelch = 1; rpelch = 0; sacrchc = 0; pubsymchc = 0; lsacrochc = 1; lsacrotchc = 1; ltendinchc = 1; rsacrochc = 0; rsacrotchc = 0;rtendinchc = 0;lcocchc = 1;licocchc = 1;lobtchc = 1;lpirchc = 1;lpubchc = 1;lsphchc = 1;rsphchc = 0;rpubchc = 0;rpirchc = 0;robtchc = 0;ricocchc = 0;rcocchc = 0;lblachc = 1;lbubchc = 1;lvaschc = 1;lprocchc = 1;lprochc = 1;lsemchc = 1;lureterchc = 1;lrecchc = 1;rureterchc = 0;rsemchc = 0;rprochc = 0;rprocchc = 0;rvaschc = 0;rbubchc = 0;rblachc = 0;rrecchc = 0;lbucchc = 1;lbulchc = 1;lcorcchc = 1;lcorschc = 1;lglachc = 1;liscchc = 1;lpermchc = 1;lperfchc = 1;lurethchc = 1;lurochc = 1;rbucchc = 0;rurochc = 0;rurethchc = 0;rperfchc = 0;rpermchc = 0;riscchc = 0;rglachc = 0;rcorschc = 0;rcorcchc = 0;rbulchc = 0;dvinchc = 0;susligchc = 0;lparchc = 1;lteslchc = 1;lgonachc = 1;lgonvchc = 1;lepichc = 1;lcrechc = 1;lintchc = 1;lextchc = 1;ltesrchc = 1;rparchc = 0;rintchc = 0;rteslchc = 0;rgonvchc = 0;rgonachc = 0;rextchc = 0;repichc = 0;rcrechc = 0;rtesrchc = 0;lducchc = 1;rducchc = 0;lanuchc = 1;ranuchc = 1;lpenischc = 1;rpenischc = 1;lpensfaschc = 1;rpensfaschc = 1;lpersfaschc = 1;rpersfaschc = 1;lscrotumchc = 1;rscrotumchc = 1;lssfaschc = 1;rssfaschc = 1;torsochc = 1;
			...
			function startMapLoading(path,distance,anatCont,alt) {
				...
				clap = new CL3D.CopperLicht('3darea');
				...
				clap.OnLoadingComplete = function() {
					...
					var cfov = cam.getFov()
					mfov = cfov;
					rotSceneNode = scene.getSceneNodeFromName(anatCont);
				}
...
function closehand() {
	...
	xke = x - parseInt(document.getElementById('movement').style.left,10); 
	yke = y - parseInt(document.getElementById('movement').style.top,10);
	return;
}
function openhand()
{
	...
	gate=0;
	xke=0;
	var bhg = parseInt(document.getElementById('movement').style.top,10);
	var fds = parseInt(document.getElementById('movement').style.left,10);
	var limit = window.innerHeight - 60;
	var limitx = window.innerWidth - 450;

	if (bhg < 60)
		{document.getElementById('movement').style.top = '60px';}

	if (bhg > limit)
		{document.getElementById('movement').style.top = limit + 'px';}

	if (fds < 0)
		{document.getElementById('movement').style.left = '5px';}
		
	if (fds > limitx)
		{document.getElementById('movement').style.left = window.innerWidth - 455 + 'px';}
...
function disableclick() {
	...
	setTimeout("document.getElementById('3darea').style.pointerEvents = 'auto'", 500);
			...
			function lpenisch() {			
				document.getElementById('lpenisch').style.visibility = (document.getElementById('lpenisch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('lpenisch').style.visibility = (document.getElementById('lpenisch').style.visibility == 'hidden') ? lpenischc = 1 : lpenischc = 0;
			}
			function rpenisch() {			
				document.getElementById('rpenisch').style.visibility = (document.getElementById('rpenisch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('rpenisch').style.visibility = (document.getElementById('rpenisch').style.visibility == 'hidden') ? rpenischc = 1 : rpenischc = 0;
			}
			function lpensfasch() {			
				document.getElementById('lpensfasch').style.visibility = (document.getElementById('lpensfasch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('lpensfasch').style.visibility = (document.getElementById('lpensfasch').style.visibility == 'hidden') ? lpensfaschc = 1 : lpensfaschc = 0;
			}
			function rpensfasch() {			
				document.getElementById('rpensfasch').style.visibility = (document.getElementById('rpensfasch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('rpensfasch').style.visibility = (document.getElementById('rpensfasch').style.visibility == 'hidden') ? rpensfaschc = 1 : rpensfaschc = 0;
			}
			function lpersfasch() {			
				document.getElementById('lpersfasch').style.visibility = (document.getElementById('lpersfasch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('lpersfasch').style.visibility = (document.getElementById('lpersfasch').style.visibility == 'hidden') ? lpersfaschc = 1 : lpersfaschc = 0;
			}
			function rpersfasch() {			
				document.getElementById('rpersfasch').style.visibility = (document.getElementById('rpersfasch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('rpersfasch').style.visibility = (document.getElementById('rpersfasch').style.visibility == 'hidden') ? rpersfaschc = 1 : rpersfaschc = 0;
			}
			function lscrotumch() {			
				document.getElementById('lscrotumch').style.visibility = (document.getElementById('lscrotumch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('lscrotumch').style.visibility = (document.getElementById('lscrotumch').style.visibility == 'hidden') ? lscrotumchc = 1 : lscrotumchc = 0;
			}
			function rscrotumch() {			
				document.getElementById('rscrotumch').style.visibility = (document.getElementById('rscrotumch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('rscrotumch').style.visibility = (document.getElementById('rscrotumch').style.visibility == 'hidden') ? rscrotumchc = 1 : rscrotumchc = 0;
			}
			function lssfasch() {			
				document.getElementById('lssfasch').style.visibility = (document.getElementById('lssfasch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('lssfasch').style.visibility = (document.getElementById('lssfasch').style.visibility == 'hidden') ? lssfaschc = 1 : lssfaschc = 0;
			}
			function rssfasch() {			
				document.getElementById('rssfasch').style.visibility = (document.getElementById('rssfasch').style.visibility == 'hidden') ? 'visible' : 'hidden';
				document.getElementById('rssfasch').style.visibility = (document.getElementById('rssfasch').style.visibility == 'hidden') ? rssfaschc = 1 : rssfaschc = 0;
			}
			function torsch() {			
...
function hideallskinch() {
	document.getElementById('lanuch').style.visibility = 'hidden'; document.getElementById('rpenisch').style.visibility = 'hidden'; document.getElementById('lpenisch').style.visibility = 'hidden'; document.getElementById('rpensfasch').style.visibility = 'hidden'; document.getElementById('lpensfasch').style.visibility = 'hidden'; document.getElementById('rpersfasch').style.visibility = 'hidden'; document.getElementById('lpersfasch').style.visibility = 'hidden'; document.getElementById('rscrotumch').style.visibility = 'hidden'; document.getElementById('lscrotumch').style.visibility = 'hidden'; document.getElementById('rssfasch').style.visibility = 'hidden'; document.getElementById('lssfasch').style.visibility = 'hidden'; document.getElementById('torsoch').style.visibility = 'hidden'; document.getElementById('ranuch').style.visibility = 'hidden';
	lanuchc = 1; ranuchc = 1; lpenischc = 1; rpenischc = 1; lpensfaschc = 1; rpensfaschc = 1; lpersfaschc = 1; rpersfaschc = 1; lscrotumchc = 1; rscrotumchc = 1; lssfaschc = 1; rssfaschc = 1; torsochc = 1;
}

function showallbonch() {
	document.getElementById('leftpelch').style.visibility = 'visible';
	document.getElementById('rpelch').style.visibility = 'visible';
	document.getElementById('sacrch').style.visibility = 'visible';
	document.getElementById('pubsymch').style.visibility = 'visible';
	leftpelch = 0; rpelch = 0; sacrchc = 0; pubsymchc = 0;
}

function showallligch() {
	document.getElementById('lsacroch').style.visibility = 'visible';
	document.getElementById('lsacrotch').style.visibility = 'visible';
	document.getElementById('ltendinch').style.visibility = 'visible';
	document.getElementById('rsacroch').style.visibility = 'visible';
	document.getElementById('rsacrotch').style.visibility = 'visible';
	document.getElementById('rtendinch').style.visibility = 'visible';
	lsacrochc = 0; lsacrotchc = 0; ltendinchc = 0; rsacrochc = 0; rsacrotchc = 0;	rtendinchc = 0;
}

function showallmusch() {
	document.getElementById('lcocch').style.visibility = 'visible';
	document.getElementById('licocch').style.visibility = 'visible';
	document.getElementById('lobtch').style.visibility = 'visible';
	document.getElementById('lpirch').style.visibility = 'visible';
	document.getElementById('lpubch').style.visibility = 'visible';
	document.getElementById('lsphch').style.visibility = 'visible';
	document.getElementById('rsphch').style.visibility = 'visible';
	document.getElementById('rpubch').style.visibility = 'visible';
	document.getElementById('rpirch').style.visibility = 'visible';
	document.getElementById('robtch').style.visibility = 'visible';
	document.getElementById('ricocch').style.visibility = 'visible';
	document.getElementById('rcocch').style.visibility = 'visible';
...
function showallorgch() {
	document.getElementById('lblach').style.visibility = 'visible';
	document.getElementById('lbubch').style.visibility = 'visible';
	document.getElementById('lvasch').style.visibility = 'visible';
	document.getElementById('lprocch').style.visibility = 'visible';
	document.getElementById('lproch').style.visibility = 'visible';
	document.getElementById('lsemch').style.visibility = 'visible';
	document.getElementById('lureterch').style.visibility = 'visible';
	document.getElementById('lrecch').style.visibility = 'visible';
	document.getElementById('rureterch').style.visibility = 'visible';
	document.getElementById('rsemch').style.visibility = 'visible';
	document.getElementById('rproch').style.visibility = 'visible';
	document.getElementById('rprocch').style.visibility = 'visible';
	document.getElementById('rvasch').style.visibility = 'visible';
	document.getElementById('rbubch').style.visibility = 'visible';
	document.getElementById('rblach').style.visibility = 'visible';
	document.getElementById('rrecch').style.visibility = 'visible';
...
function showallpench() {
	document.getElementById('lbucch').style.visibility = 'visible';
	document.getElementById('lbulch').style.visibility = 'visible';
	document.getElementById('lcorcch').style.visibility = 'visible';
	document.getElementById('lcorsch').style.visibility = 'visible';
	document.getElementById('lglach').style.visibility = 'visible';
	document.getElementById('liscch').style.visibility = 'visible';
	document.getElementById('lpermch').style.visibility = 'visible';
	document.getElementById('lperfch').style.visibility = 'visible';
	document.getElementById('lurethch').style.visibility = 'visible';
	document.getElementById('luroch').style.visibility = 'visible';
	document.getElementById('rbucch').style.visibility = 'visible';
	document.getElementById('ruroch').style.visibility = 'visible';
	document.getElementById('rurethch').style.visibility = 'visible';
	document.getElementById('rperfch').style.visibility = 'visible';
	document.getElementById('rpermch').style.visibility = 'visible';
	document.getElementById('riscch').style.visibility = 'visible';
	document.getElementById('rglach').style.visibility = 'visible';
	document.getElementById('rcorsch').style.visibility = 'visible';
	document.getElementById('rcorcch').style.visibility = 'visible';
	document.getElementById('rbulch').style.visibility = 'visible';
	document.getElementById('dvinch').style.visibility = 'visible';
	document.getElementById('susligch').style.visibility = 'visible';
...
function showalltesch() {
	document.getElementById('lparch').style.visibility = 'visible';
	document.getElementById('lteslch').style.visibility = 'visible';
	document.getElementById('lgonach').style.visibility = 'visible';
	document.getElementById('lgonvch').style.visibility = 'visible';
	document.getElementById('lepich').style.visibility = 'visible';
	document.getElementById('lcrech').style.visibility = 'visible';
	document.getElementById('lintch').style.visibility = 'visible';
	document.getElementById('lextch').style.visibility = 'visible';
	document.getElementById('ltesrch').style.visibility = 'visible';
	document.getElementById('rparch').style.visibility = 'visible';
	document.getElementById('rintch').style.visibility = 'visible';
	document.getElementById('rteslch').style.visibility = 'visible';
	document.getElementById('rgonvch').style.visibility = 'visible';
	document.getElementById('rgonach').style.visibility = 'visible';
	document.getElementById('rextch').style.visibility = 'visible';
	document.getElementById('repich').style.visibility = 'visible';
	document.getElementById('rcrech').style.visibility = 'visible';
	document.getElementById('rtesrch').style.visibility = 'visible';
	document.getElementById('lducch').style.visibility = 'visible';
	document.getElementById('rducch').style.visibility = 'visible';
...
function showallskinch() {
	document.getElementById('lanuch').style.visibility = ''; document.getElementById('rpenisch').style.visibility = ''; document.getElementById('lpenisch').style.visibility = ''; document.getElementById('rpensfasch').style.visibility = ''; document.getElementById('lpensfasch').style.visibility = ''; document.getElementById('rpersfasch').style.visibility = ''; document.getElementById('lpersfasch').style.visibility = ''; document.getElementById('rscrotumch').style.visibility = ''; document.getElementById('lscrotumch').style.visibility = ''; document.getElementById('rssfasch').style.visibility = ''; document.getElementById('lssfasch').style.visibility = ''; document.getElementById('torsoch').style.visibility = ''; document.getElementById('ranuch').style.visibility = '';
	lanuchc = 0; ranuchc = 0; lpenischc = 0; rpenischc = 0; lpensfaschc = 0; rpensfaschc = 0; lpersfaschc = 0; rpersfaschc = 0; lscrotumchc = 0; rscrotumchc = 0; lssfaschc = 0; rssfaschc = 0; torsochc = 0;
}
...
function lsagchch() { leftpelch = 0; rpelch = 1; sacrchc = 0; pubsymchc = 0; lsacrochc = 0; lsacrotchc = 0; ltendinchc = 0; rsacrochc = 1; rsacrotchc = 1;	rtendinchc = 1;	lcocchc = 0; licocchc = 0; lobtchc = 0; lpirchc = 0; lpubchc = 0; lsphchc = 0; rsphchc = 1; rpubchc = 1; rpirchc = 1; robtchc = 1; ricocchc = 1; rcocchc = 1; lblachc = 0; lbubchc = 0; lvaschc = 0; lprocchc = 0; lprochc = 0; lsemchc = 0; lureterchc = 0; lrecchc = 0; rureterchc = 1; rsemchc = 1; rprochc = 1; rprocchc = 1; rvaschc = 1; rbubchc = 1; rblachc = 1; rrecchc = 1; lbucchc = 0; lbulchc = 0; lcorcchc = 0; lcorschc = 0; lglachc = 0; liscchc = 0; lpermchc = 0; lperfchc = 0; lurethchc = 0; lurochc = 0; rbucchc = 1; rurochc = 1; rurethchc = 1; rperfchc = 1; rpermchc = 1; riscchc = 1;	rglachc = 1; rcorschc = 1; rcorcchc = 1; rbulchc = 1; dvinchc = 0; susligchc = 0; lparchc = 0; lteslchc = 0; lgonachc = 0; lgonvchc = 0; lepichc = 0; lcrechc = 0; lintchc = 0;	lextchc = 0; ltesrchc = 0; rparchc = 1;	rintchc = 1; rteslchc = 1; rgonvchc = 1; rgonachc = 1; rextchc = 1;	repichc = 1; rcrechc = 1; rtesrchc = 1;	lducchc = 0; rducchc = 1; document.getElementById('prehov1').style.visibility = 'hidden'; document.getElementById('presetline').style.visibility = 'hidden'; document.getElementById('infotext2').style.visibility = 'hidden';}
		...
		function leftpelvischz() {
			...
			function lpenischz() {			
				document.getElementById('lpenisu').style.textDecoration = 'none';
				document.getElementById('lpenisch').style.visibility = 'hidden';
				lpenischc = 1;
			}
			function rpenischz() {			
				document.getElementById('rpenisu').style.textDecoration = 'none';
				document.getElementById('rpenisch').style.visibility = 'hidden';
				rpenischc = 1;
			}
			function lpensfaschz() {			
				document.getElementById('lpensfasu').style.textDecoration = 'none';
				document.getElementById('lpensfasch').style.visibility = 'hidden';
				lpensfaschc = 1;
			}
			function rpensfaschz() {			
				document.getElementById('rpensfasu').style.textDecoration = 'none';
				document.getElementById('rpensfasch').style.visibility = 'hidden';
				rpensfaschc = 1;
			}
			function lpersfaschz() {			
				document.getElementById('lpersfasu').style.textDecoration = 'none';
				document.getElementById('lpersfasch').style.visibility = 'hidden';
				lpersfaschc = 1;
			}
			function rpersfaschz() {			
				document.getElementById('rpersfasu').style.textDecoration = 'none';
				document.getElementById('rpersfasch').style.visibility = 'hidden';
				rpersfaschc = 1;
			}
			function lscrotumchz() {			
				document.getElementById('lscrotumu').style.textDecoration = 'none';
				document.getElementById('lscrotumch').style.visibility = 'hidden';
				lscrotumchc = 1;
			}
			function rscrotumchz() {			
				document.getElementById('rscrotumu').style.textDecoration = 'none';
				document.getElementById('rscrotumch').style.visibility = 'hidden';
				rscrotumchc = 1;
			}
			function lssfaschz() {			
				document.getElementById('lssfasu').style.textDecoration = 'none';
				document.getElementById('lssfasch').style.visibility = 'hidden';
				lssfaschc = 1;
			}
			function rssfaschz() {			
				document.getElementById('rssfasu').style.textDecoration = 'none';
				document.getElementById('rssfasch').style.visibility = 'hidden';
				rssfaschc = 1;
			}
			function torschz() {			
